...
import PromedioTile from "../../../src/client/tiles/promedio-tile/components/promedio-tile";

const stories = storiesOf('Promedio | Tile / Single', module);
...
stories.add('with 1 x 1 dimensions', () => (
  <MockTileGrid 
    extraTiles="5"
    minCols="2"
    withKnobs="PromedioTile"
    component={PromedioTile}
    enableMocks
    menuOption={{
      desc,
      image,
