...
import { computeWeightedAverage, computeNeededGrade, computeWeightedAverageGivenTotalWeight, computeMaximumGrade } from "./utils";

export function computeFinalGradeOfCourse(course) {
...
export function computeNeededGradeForCourse(course, desiredGrade) {
...
export function replaceGradeOfUnLockedComponents(components, grade) {
